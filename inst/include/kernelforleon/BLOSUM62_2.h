...
namespace constants {
    template<unsigned short C1, unsigned short C2>
...
switch (value_2) {                                                                                                     \
    case 'A':    return constants::BLOSUM62_2<CODON_1##u, 0u>;                                                          \
    case 'C':    return constants::BLOSUM62_2<CODON_1##u, 1u>;                                                          \
    case 'D':    return constants::BLOSUM62_2<CODON_1##u, 2u>;                                                          \
    case 'E':    return constants::BLOSUM62_2<CODON_1##u, 3u>;                                                          \
    case 'F':    return constants::BLOSUM62_2<CODON_1##u, 4u>;                                                          \
    case 'G':    return constants::BLOSUM62_2<CODON_1##u, 5u>;                                                          \
    case 'H':    return constants::BLOSUM62_2<CODON_1##u, 6u>;                                                          \
    case 'I':    return constants::BLOSUM62_2<CODON_1##u, 7u>;                                                          \
    case 'K':    return constants::BLOSUM62_2<CODON_1##u, 8u>;                                                          \
    case 'L':    return constants::BLOSUM62_2<CODON_1##u, 9u>;                                                          \
    case 'M':    return constants::BLOSUM62_2<CODON_1##u, 10u>;                                                        \
    case 'N':    return constants::BLOSUM62_2<CODON_1##u, 11u>;                                                        \
    case 'P':    return constants::BLOSUM62_2<CODON_1##u, 12u>;                                                        \
    case 'Q':    return constants::BLOSUM62_2<CODON_1##u, 13u>;                                                        \
    case 'R':    return constants::BLOSUM62_2<CODON_1##u, 14u>;                                                        \
    case 'S':    return constants::BLOSUM62_2<CODON_1##u, 15u>;                                                        \
    case 'T':    return constants::BLOSUM62_2<CODON_1##u, 16u>;                                                        \
    case 'V':    return constants::BLOSUM62_2<CODON_1##u, 17u>;                                                        \
    case 'W':    return constants::BLOSUM62_2<CODON_1##u, 18u>;                                                        \
    case 'Y':    return constants::BLOSUM62_2<CODON_1##u, 19u>;                                                        \
    default:    throw std::invalid_argument("translation must be made with twenty standard amino acid letters only");  \
}

    constexpr double read_BLOSUM62_2(char value_1, char value_2) {
        switch (value_1) {
            case 'A':    SECOND_CODON(0)
            case 'C':    SECOND_CODON(1)
            case 'D':    SECOND_CODON(2)
            case 'E':    SECOND_CODON(3)
            case 'F':    SECOND_CODON(4)
            case 'G':    SECOND_CODON(5)
            case 'H':    SECOND_CODON(6)
            case 'I':    SECOND_CODON(7)
            case 'K':    SECOND_CODON(8)
            case 'L':    SECOND_CODON(9)
            case 'M':   SECOND_CODON(10)
            case 'N':   SECOND_CODON(11)
            case 'P':   SECOND_CODON(12)
            case 'Q':   SECOND_CODON(13)
            case 'R':   SECOND_CODON(14)
            case 'S':   SECOND_CODON(15)
            case 'T':   SECOND_CODON(16)
            case 'V':   SECOND_CODON(17)
            case 'W':   SECOND_CODON(18)
            case 'Y':   SECOND_CODON(19)
            default:    throw std::invalid_argument("translation must be made with twenty standard amino acid letters only");
        }
    }
